...
#Path of datax2: test/delta_P5S_z15_Dk6_box_particles_input_run1.txt 
#Path of randomsx2: none
#Path of output: ./test
#Identifier of output: z15_Dk6_box_density_input_run1
#Write header: yes
#Write density: no
...
#Value of Pnoise (double) 305.147934
