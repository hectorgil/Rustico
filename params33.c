#Main parameters
#Type of code (rustico/rusticoX): rusticoX
#Type of Box (periodic/cutsky): cutsky
#Type of file (ascii/gadget)x2: ascii ascii
#Number of gadget files(int)x2: 16 16
#RSD distorsion on gadget periodic box (yes/no)x2: yes yes
...
#Path of datax2: /DATA/hector/challenge_mocks/NSeriesCutsky/CutskyN1.rdzw /DATA/hector/challenge_mocks/NSeriesCutsky/CutskyN2.rdzw
#Path of randomsx2: /DATA/hector/challenge_mocks/NSeriesCutsky/Nseries_cutsky_randoms_50x_redshifts.dat /DATA/hector/challenge_mocks/NSeriesCutsky/Nseries_cutsky_randoms_50x_redshifts.dat
#Path of output: ./test
#Identifier of output: Nseries_1x2
#Write header: yes
...
#Cutsky parameters
#Redshift Range (double/double)x2: 0.43 0.70 0.43 0.70
#Omega matter value (double): 0.31
#Area effective value in deg^2 (double)x2: 7341.000000 7341.000000
