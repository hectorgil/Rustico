...
#Path of datax2: /DATA/hector/box1p_fixed.txt
#Path of randomsx2: /DATA/hector/box1p_fixed_20xrandoms.txt
#Path of output: ./test
#Identifier of output: box1p_periodicFKP_fixed_x20rand
#Write header: yes
#Write density: no
