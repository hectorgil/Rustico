...
#Size of the Box (double/double): 0 +3000.
...
#k-range for computation (double/double): 0 0.53
...
#Path of datax2: /DATA2/hector/desi_mock_challenge2/20200514-unit-elg-3gpc-REAL.dat
#Path of randomsx2: none
#Path of output: /DATA2/hector/desi_mock_challenge2
#Identifier of output: z09873_3Gpch_runREAL
#Write header: yes
#Write density: no
