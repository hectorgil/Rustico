...
#Size of the Box (double/double): -2000. +2000.
...
#Path of randomsx2: /DATA/hector/challenge_mocks/NSeriesCutsky/Nseries_cutsky_randoms_50x_redshifts.dat 
#Path of output: ./test
#Identifier of output: Nseries4000_1Gridav2
#Write header: yes

#FFT parameters
#Number of Grid Cells power (int): 8
#Type of mass assingment (NGC/CIC/TSC/PCS/P4S/P5S): PCS
#Type of Yamamoto (GridCenter/GridAverage): GridAverage
...
#Hexadecapole as (L0L4/L2L2/L1L3): L0L4
