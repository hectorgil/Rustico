...
#Type of file (ascii/gadget)x2: gadget ascii
...
#Path of datax2: /DATA/cwagner/newcov/1/snapshot_004 /DATA/hector/Christian_haloes_5e13/2400Mpc_1_4_AHF_halos
#Path of randomsx2: none none
#Path of output: ./test
#Identifier of output: z0_cross_DM_X_Halo_run1
#Write header: yes
