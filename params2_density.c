...
#k-range for computation (double/double): 0 0.12
...
#Path of datax2: test/delta_P5S_boss_input_particles_bispec_run1.txt
#Path of randomsx2: none
#Path of output: ./test
#Identifier of output: boss_input_density_bispec_run1
#Write header: yes
#Write density: no
...
#Value of Bnoise1 (double)  5.076509e+03
#Value of Bnoise2 (double) 5.386156e+07
#I22 normalization (double): 4.308510e+00
#I33 normalization (double): 3.035303e-04
