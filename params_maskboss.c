...
#Size of the Box (double/double): -3700 +3800.
...
#Path of datax2: none
#Path of randomsx2: /DATA/hector/BOSS_dr12v5_data/cmass/random0_DR12v5_CMASS_South_t1.txt
#Path of output: ./test
#Identifier of output: mask_boss_cmass_sgc_yamamotoL2L2_1p_blindcuts
#Write header: yes
#Write density: no
...
#Cutsky parameters
#Redshift Range (double/double)x2: 0.45 0.70
#Omega matter value (double): 0.31
#Area effective value in deg^2 (double)x2: 1.0
#Smoothing scale for normalization in Mpc/h (double): 0. 
#Quadrupole as (L0L2/L1L1): L0L2
#Octopole as (L0L3/L1L2): L0L3
