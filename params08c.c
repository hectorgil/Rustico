...
#Type of file (ascii/gadget)x2: gadget gadget
...
#Path of datax2: /DATA/cwagner/newcov/1/snapshot_004 /DATA/cwagner/newcov/2/snapshot_004
#Path of randomsx2: none none
#Path of output: ./test
#Identifier of output: z0_cross_DM_X_DM_run1_2
#Write header: yes
