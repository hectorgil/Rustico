...
#k-range for computation (double/double): 0 6.42
...
#Path of randomsx2: no
#Path of output: ./desi
#Identifier of output: Seo_recIso_redSm15Iso_bin005_norandoms_2048
#Write header: yes
#Write density: no

#FFT parameters
#Number of Grid Cells power (int): 11
