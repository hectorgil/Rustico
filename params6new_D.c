...
#Path of output: ./test
#Identifier of output: Nseries_1_window_new_D
#Write header: yes
...
#Cutsky parameters
#Redshift Range (double/double)x2: 0.5 0.6
...
#Shuffle randoms (no/redshift/radec/both): radec
#Write shuffled randoms (yes/no): yes
