...
#Type of file (ascii/gadget)x2: ascii gadget
...
#Path of datax2: /DATA/hector/Christian_haloes_5e13/2400Mpc_1_4_AHF_halos /DATA/cwagner/newcov/1/snapshot_004
#Path of randomsx2: none none
#Path of output: ./test
#Identifier of output: z0_cross_Halo_X_DM_run1
#Write header: yes
